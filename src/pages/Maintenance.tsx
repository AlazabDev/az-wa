...
const requests = [
  {
    id: 1,
    title: "تسريب مياه - الطابق الثالث",
    building: "برج السلام السكني",
    client: "شركة الأفق",
    priority: "عاجل",
    status: "open",
    assignee: "فريق السباكة",
    date: "2024-12-01",
    description: "تسريب مياه من السقف في الشقة 305",
  },
  {
    id: 2,
    title: "صيانة مصعد رقم 2",
    building: "مجمع النور التجاري",
    client: "مؤسسة النور",
    priority: "متوسط",
    status: "in_progress",
    assignee: "فريق المصاعد",
    date: "2024-11-28",
    description: "المصعد يتوقف بين الطوابق بشكل متكرر",
  },
  {
    id: 3,
    title: "إصلاح لوحة كهربائية",
    building: "فيلا الورد",
    client: "أحمد العلي",
    priority: "عادي",
    status: "open",
    assignee: "غير معين",
    date: "2024-11-25",
    description: "اللوحة الكهربائية الرئيسية تحتاج استبدال",
  },
  {
    id: 4,
    title: "تشققات في الجدار الخارجي",
    building: "مبنى إداري - الملك فهد",
    client: "بنك الاستثمار",
    priority: "متوسط",
    status: "completed",
    assignee: "فريق البناء",
    date: "2024-11-20",
    description: "تشققات ظاهرة في الواجهة الغربية",
  },
  {
    id: 5,
    title: "تسريب سقف - غرفة الاجتماعات",
    building: "مجمع النور التجاري",
    client: "مؤسسة النور",
    priority: "عاجل",
    status: "in_progress",
    assignee: "فريق العزل",
    date: "2024-12-02",
    description: "تسريب مياه أمطار من السقف",
  },
  {
    id: 6,
          ...
          <DialogContent className="max-w-lg" dir="rtl">
            ...
            <div className="space-y-4 mt-4">
              <div>
                ...
                <Input placeholder="مثال: تسريب مياه" className="mt-1" />
              </div>
              <div>
                <Label>المبنى / الموقع</Label>
                <Input placeholder="اسم المبنى أو الموقع" className="mt-1" />
              </div>
              <div>
              ...
              <div>
                <Label>الوصف</Label>
                <Textarea placeholder="اشرح المشكلة بالتفصيل..." className="mt-1" />
              </div>

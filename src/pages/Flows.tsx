...
const flows = [
  {
    id: 1,
    name: "تدفق طلب صيانة جديد",
    status: "active",
    triggers: "عند استلام طلب صيانة",
    steps: 5,
    description: "إشعار العميل ← تعيين فريق ← جدولة الموعد ← تأكيد ← متابعة",
  },
  {
    id: 2,
    name: "تقرير تقدم مشروع أسبوعي",
    status: "active",
    triggers: "كل يوم أحد 9 صباحاً",
    steps: 3,
    description: "جمع البيانات ← إنشاء التقرير ← إرسال للعميل",
  },
  {
    id: 3,
    name: "تذكير بموعد صيانة دورية",
    status: "paused",
    triggers: "قبل 48 ساعة من الموعد",
    steps: 4,
    description: "تذكير العميل ← تأكيد الفريق ← إرسال التفاصيل ← متابعة",
  },
  {
    id: 4,
    name: "إشعار اكتمال مرحلة",
    status: "active",
    triggers: "عند تحديث حالة المرحلة",
    steps: 3,
    description: "إشعار المدير ← إشعار العميل ← طلب موافقة",
  },
  {
    id: 5,
    name: "ترحيب عميل جديد",
    status: "draft",
    triggers: "عند إضافة عميل جديد",
    steps: 4,
    description: "رسالة ترحيب ← إرسال دليل الخدمات ← جدولة اجتماع ← متابعة",
  },
];

const statusMap: Record<
  string,
  { label: string; variant: "default" | "secondary" | "outline"; icon: typeof Play }
> = {
    ...
    <AppLayout
      ...
      actions={
        <Button
          ...
          onClick={() => navigate({ to: "/legacy/flows/new" })}
        >
